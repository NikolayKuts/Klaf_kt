...
class IosNoOpDeckReviewNotifier : IDeckReviewNotifierManager {
...
class IosNoOpCambridgeWordDataProvider : ICambridgeWordDataProvider {

    override suspend fun fetchWordData(word: String): CambridgeWordData? = null
}

class IosInMemoryDeckReviewStateStore : IDeckReviewStateStore {
