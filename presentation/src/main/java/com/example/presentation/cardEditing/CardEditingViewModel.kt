...
import com.example.presentation.cardAddition.AutocompleteState
...
class CardEditingViewModel @AssistedInject constructor(
    ...
    override val autocompleteState: MutableStateFlow<com.example.presentation.cardAddition.AutocompleteState> =
        MutableStateFlow(value = com.example.presentation.cardAddition.AutocompleteState())
    ...
    override fun updateAutocompleteState(word: String) {
        ...
        autocompleteFetchingJob = viewModelScope.launch(Dispatchers.IO) {
            autocompleteState.value = com.example.presentation.cardAddition.AutocompleteState(
                prefix = clearedWord,
