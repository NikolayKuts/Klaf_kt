...
import com.example.presentation.common.EventMessage
import com.example.presentation.common.notifications.NotificationChannelInitializer
import com.example.presentation.common.tryEmit
import com.example.presentation.deckList.common.DeckListNavigationDestination.*
import com.example.presentation.deckList.common.DeckListNavigationEvent.*
...
class DeckListViewModel @AssistedInject constructor(
    ...
    private val getDataSynchronizationProgressState: GetDataSynchronizationProgressStateUseCase,
...
//        workManager.scheduleAppReopening()
    ...
    private fun observeDataSynchronizationStateWorker() {
        getDataSynchronizationProgressState()
