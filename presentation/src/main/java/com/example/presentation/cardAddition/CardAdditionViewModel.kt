...
import com.example.presentation.cardAddition.CardAdditionEvent.*
...
class CardAdditionViewModel @AssistedInject constructor(
    ...
    override val pronunciationPlayer: PronunciationPlayerRepository,
    ...
    init {
        combine(
            ...
            pronunciationPlayer.preparePronunciation(word = addingState.foreignWord)
    ...
    override fun sendEvent(event: CardAdditionEvent) {
        when (event) {
            ...
            PronounceForeignWord -> pronunciationPlayer.playPronunciation()
