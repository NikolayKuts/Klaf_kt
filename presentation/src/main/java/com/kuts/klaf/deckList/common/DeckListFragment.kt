...
import com.kuts.klaf.authentication.AuthenticationFragment.Companion.setAuthenticationFragmentResultListener
...
import com.kuts.klaf.deckList.dataSynchronization.DataSynchronizationDialogFragmentDirections
...
class DeckListFragment : BaseFragment(layoutId = R.layout.common_compose_layout) {
    ...
    private fun navigateToChatGpt() {
        val intent = Intent(
            Intent.ACTION_VIEW,
            SecretConstants.ChatGpt.STORY_CRAFTER_URL.toUri()
