...
class DataSynchronizationWorker @AssistedInject constructor(
    ...
    companion object {
        ...
        fun WorkManager.getDataSynchronizationProgressState(): Flow<IDataSynchronizationState> {
            ...
            return progressState.map { workInfos ->
                ...
                val synchronizationState = when {
                    ...
                    workInfoState == WorkInfo.State.SUCCEEDED && wasRunning -> {
                        IDataSynchronizationState.SuccessfullyFinished
                    }
                    workInfoState.isFailed && wasRunning -> IDataSynchronizationState.Failed
                    else -> IDataSynchronizationState.Uncertain
                }
