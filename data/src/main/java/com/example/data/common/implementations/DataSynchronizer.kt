...
class DataSynchronizer @Inject constructor(
    ...
    override fun synchronize(): Flow<String> = channelFlow {
        ...
        withContext(Dispatchers.IO) {
            ...
            when {
                ...
                dataSynchronizationValidator.shouldRemoteStorageBeUpdated(
                    ...
                    val targetVersion =
                        (remoteSaveVersion?.version ?: StorageSaveVersion.INITIAL_SAVE_VERSION) + INCREMENT_STEP
    ...
    private fun CoroutineScope.updateStorageSaveVersion(
        ...
        val updatedStorageSaveVersion =
            StorageSaveVersion(version = targetVersion ?: StorageSaveVersion.INITIAL_SAVE_VERSION)
